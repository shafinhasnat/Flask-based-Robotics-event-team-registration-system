...
if ENV == 'dev':
	...
	app.debug=False
	app.config['SQLALCHEMY_DATABASE_URI'] = "postgres://wqojuftlwmxvdi:91f8d07669fa5aa7a389507c8f33ca3e3f097776673cab66a5856925e6ec7a0e@ec2-174-129-253-104.compute-1.amazonaws.com:5432/daui007rqo5cp4"
